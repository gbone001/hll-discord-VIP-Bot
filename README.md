...
| `QUICK_VIP_ROLE_IDS` | Optional | Comma-separated env var or JSON array of Discord role IDs that are allowed to use Quick VIP under the newer `1 per 48 hours` rule. The bot now includes `MSU` (`1322175167685988403`) and `Randoms` (`1440534025054720020`) as built-in nominated roles by default. Legacy clan Quick VIP roles still keep their existing quota. |
...
```json5
{
  ...
  QUICK_VIP_ROLE_IDS: [1322175167685988403, 1440534025054720020, 345678901234567890, 456789012345678901],
...
6. Users with `QUICK_VIP_ROLE_IDS` can use it once every 48 hours. By default this includes the `MSU` role (`1322175167685988403`) and the `Randoms` role (`1440534025054720020`).
